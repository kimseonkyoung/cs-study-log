...
## 프로그래머스 추천 문제 (세부 강의별 매핑)

진행 단위: 세부 강의 1~2개 → 개념 정리 → 아래 매핑된 문제 풀이.

**강의 1~2 (문자 찾기, 대소문자 변환) 듣고:**
...
**강의 3~5 (문장 속 단어, 단어 뒤집기, 특정 문자 뒤집기) 듣고:**
- [ ] 이상한 문자 만들기 (lv1)
- [ ] 문자열 내 마음대로 정렬하기 (lv1)

**강의 6~9 (중복문자제거, 회문, 팰린드롬, 숫자만 추출) 듣고:**
- [ ] 최댓값과 최솟값 (lv1)

**강의 10~12 (문자자리, 문자열 압축, 암호) 듣고 — 섹션 마무리 종합:**
- [ ] 신규 아이디 추천 (lv1, 조금 어려움 — 정규식·replace 종합)
